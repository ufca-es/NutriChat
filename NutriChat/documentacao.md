...
Para que haja a persistência no aprendizado, foi criado o arquivo aprendizado.txt que armazena as informações referentes às perguntas que o chat não soube responder em um primeiro momento por falta desses dados no arquivo de perguntas e respostas.

Nessa classe, a função salvar vai gravar as perguntas e abrir o arquivo .txt para salvar essas informações. Já a estrutura condicional dentro da funçaõ carregar, vai verificar se essa pergunta já foi salva no arquivo, conforme novas perguntas forem adicionadas.

<img width="1410" height="695" alt="image" src="https://github.com/user-attachments/assets/62d3e4bc-254e-45a4-bdf3-1dad33aff040" />
...
O Nutri contribui para a melhoria da saúde dos seus usuários a partir da motivação pela escolha de refeições saudáveis e contribui com o meio ambiente ao incentivar o consumo consciente. Segundo o portal do G1, a obesidade atinge um em cada três brasileiros.
E de acordo com o último Atlas Mundial da Obesidade, 68% da população possui excesso de peso e 31% desses tem obesidade. Diante disso, muitas dessas pessoas tem uma dificuldade latente de emagrecer
